...
@section('content')
 <table id="cart" class="table table-hover table-condensed">
    ...
    <tbody>
        ...
        @if(session('cart'))
            @foreach(session('cart') as $id => $details)
                ...
                class="fa fa-refresh"></i>Salvare modificări</button>
                 <button class="btn btn-danger btn-sm remove-from-cart" data-id="{{ $id }}"><i
                class="fa fa-trash-o"></i>Ștergere</button>
                </td>
                </tr>
            @endforeach
        @endif
    ...
    <td><a href="{{ url('finalize_cmd/') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i>
    Finalizare Comanda</a></td>
